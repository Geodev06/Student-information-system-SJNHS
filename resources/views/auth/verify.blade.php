        ...
        <div class="row mt-5">
            <div class="col-lg-8 mt-5 mx-auto">
                <div class="card-body bg-white p-5 border h-100">
                    ...
                    <form id="resetForm">
                        @csrf
                        <input type="hidden" name="reset_token" value="{{$email[0]->token}}">
                        <div class="form-floating mb-3">
                            <input disabled type="text" class="form-control" placeholder="Question" autocomplete="off" value="{{ $data[0]->security_question }}" name="security_question" />
                        ...
                        <div class="form-floating mb-3">
                            ...
                            <span class="text-danger error_security_answer"></span>
                        </div>
